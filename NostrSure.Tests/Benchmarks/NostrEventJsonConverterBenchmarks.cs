...
public class NostrEventJsonConverterBenchmarks
{
    ...
    public NostrEventJsonConverterBenchmarks()
    {
        ...
        _simpleEvent = new NostrEvent(
            ...
            {
                new() { "p", "3bf0c63fcb93463407af97a5e5ee64fa883d107ef9e558472c4eb9aaaefa459d" }
            },
            "Simple test message",
        ...
        _complexEvent = new NostrEvent(
            ...
            new List<List<string>>
            {
                new() { "p", "b66be78da89991544a05c3a2b63da1d15eefe8e9a1bb6a4369f8616865bd6b7c" },
                new() { "p", "a39199ccb5ec92b1cd047bf3dc7e8923ede769d1a5ccc47d579912f0f5cbdab4" },
                new() { "e", "9007b89f5626b945174a2a8c8d9d0aefc44389fcdd45da2d14ec21bd2f943efe" },
                new() { "t", "nostr" },
                new() { "t", "bitcoin" },
        ...
        _largeContentEvent = new NostrEvent(
            ...
            new List<List<string>>
            {
                new() { "p", "abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890" },
                new() { "e", "fedcba0987654321fedcba0987654321fedcba0987654321fedcba0987654321" },
                new() { "t", "performance" },
                new() { "t", "testing" }
            },
            largeContent,
